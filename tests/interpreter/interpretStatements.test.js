...
export const interpret_statements_test = () => {
    describe('interpret statements', () => {
        ...
        //     expect(result).toBe(expected)
        // })
        // it('interpret if 5 > 2 then println("1") else println("2") end', () => {
        //     const source = ' if 5 > 2 then println("1") else println("2") end'
        //     const tokens = tokenize({
        //         source,
        //         current: 0,
        //         start: 0,
        ...
        //     expect(result).toBe(expected)
        // })
        // it('interpret if 5 > 2 then println("1") end', () => {
        //     const source = ' if 5 > 2 then println("1") end'
        //     const tokens = tokenize({
        //         source,
        //         current: 0,
        //         start: 0,
